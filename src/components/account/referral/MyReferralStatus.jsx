...
import { ReferralStatuss } from '@/components/account/referral/ReferralStatuss'
import { ReferralStatusAll } from '@/components/account/referral/ReferralStatusAll'

export function MyReferralStatus() {
  return (
    <div className="">
      <div>
