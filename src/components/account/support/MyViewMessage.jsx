...
import { ViewMessages } from '@/components/account/support/ViewMessages'


export function MyViewMessage() {
  return (
    <div className="">
      <div>
        <main className="bg-white rounded-lg max-w-7xl mx-auto pb-16 px-4 pt-4 sm:pb-10 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="pt-6 lg:grid lg:grid-cols-4 lg:gap-x-2 xl:grid-cols-5">
            <MyDashboard />
            {/* Product grid */}
            <div className="mt-6 lg:mx-10 lg:mt-0 lg:col-span-3 xl:col-span-4">
