...
export function Abouts() {
    return (
      <>
      <ContentBanner className="bg-maincolor pb-8 rounded-lg" titles="About Us" subtitles="namecost" />
      <div className="w-full  py-16">
      <div className="flow-root mx-auto max-w-md px-4 sm:max-w-4xl sm:px-6 lg:max-w-5xl lg:px-8 py-16 bg-gray-50 py-8 rounded-lg  overflow-hidden shadow-lg">
        <div className="mx-auto max-w-md px-4 sm:max-w-4xl sm:px-6 lg:max-w-5xl lg:px-8  pt-8 pb-16">
